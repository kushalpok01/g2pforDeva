...
OUTPUT_FILE = "hindi_dataset3.tsv"
PROGRESS_FILE = "scrape_progress_hindi.json"
LOG_FILE = "scraper_hindi.log"

API_URL = "https://en.wiktionary.org/w/api.php"
SLEEP_SEC = 0.25
HEADERS = {"User-Agent": "HindiIPA-Dataset/1.0 (research)"}
...
# ================= IPA EXTRACTION =================
def extract_hindi_ipa(html):
    """Extract IPA from Hindi section."""
    if not html:
        return []
    ...
    # Find the Hindi pronunciation Wikipedia link
    hindi_links = soup.find_all("a", href="/wiki/Appendix:Hindi_pronunciation")
